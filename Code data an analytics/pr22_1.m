...
% g1=load a1.mat;
% % g1=load ('Dio_sadar-07-31.08.18.14.40.05 (BPM=71).CSV');
% % g=g1(:,1)';
% g1=xlsread('A1.csv');
% g=g1(:,4)';
g1=importdata('D:\Tugas\ETB 2\EEG\Data.xlsx'); % Ubah sesuai dengan nama file 
g=g1(:,7); % Pilih Channel yang akan diamati
